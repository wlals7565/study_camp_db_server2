...
export class LectureItemsController {
  ...
  async createLectureItemInLecture(
    @Body() createLectureItemsDto: CreateLectureItemsDto,
  ) {
    return await this.lectureItemsService.createLectureItemInLecture(
      createLectureItemsDto,
    );
  }
  ...
  async findAllLectureItemsByLectureID(lectureId) {
    return await this.lectureItemsService.findAllLectureItemsByLectureID(
      lectureId,
    );
  }
}
